...
var lendSchema = new Schema({
  ...
  info: {
    type: String,
    match: [/.{50,1000}/, 'info must be between 50 - 1000 characters.']
  },
  duration: {
    type: Number,
...
var bookSchema = new Schema({
  title: { type: String,
    ...
    match: [/.{5,40}/, 'title must be greater than 5 characters.']
  },
  description: {
    type: String,
    match: [/.{5,1000}/, 'description length must be between  5 - 1000 characters.'] },
  ...
  image: {
    ...
    validate: { validator: _validator.isURL }
  },
